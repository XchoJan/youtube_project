...
export interface ISliderIntro {
    ...
    useCustomBackHandlerEffect: (active: number, onBackPress: (backHandlerBehaviour: 'activeMinusOne' | 'previous', slide: ISlide, setSlide: (arg0: ISlide) => void, numberOfSlide: number, onDone: () => void, navContainerMaxSize: number, dotWidth: number, deviceMaxWidth: number) => boolean, backHandlerBehaviour: 'activeMinusOne' | 'previous', slide: ISlide, setSlide: (arg0: ISlide) => void, numberOfSlide: number, onDone: () => void, navContainerMaxSize: number, dotWidth: number, deviceMaxWidth: number) => void;
